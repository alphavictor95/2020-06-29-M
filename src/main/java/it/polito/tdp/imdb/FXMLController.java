...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	boxRegista.getItems().addAll(model.getDirectors(anno));
    		...
    		e.printStackTrace();
    		txtResult.appendText("Selezionare un anno dalla tendina.");
    		return;
    	}
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	Director selezionato = boxRegista.getValue();
    	
    	if(selezionato==null) {
    		txtResult.appendText("Selezionare un regista dalla tendina.");
    		return;
    	}
    	txtResult.appendText(model.getAdiacenti(selezionato));
